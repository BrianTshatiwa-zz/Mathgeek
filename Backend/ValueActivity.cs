...
namespace MATHGEEK
{
    [Activity(Label = "ValueActivity")]
    public class ValueActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.value_activity);
            ...
            next.Click += delegate
            {
                var intent = new Intent(this, typeof(TermActivity));
