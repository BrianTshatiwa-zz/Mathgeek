...
namespace MATHGEEK
{
    [Activity(Label = "ExponentActivity")]
    public class ExponentActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.exponent_activity);
            ...
            next.Click += delegate
            {
                var intent = new Intent(this, typeof(ValueActivity));
